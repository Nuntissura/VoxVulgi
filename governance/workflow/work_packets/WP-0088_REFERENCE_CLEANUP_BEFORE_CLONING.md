...
- 2026-03-06: Completed. Added per-speaker cleanup runs (denoise, de-reverb, speech focus, normalize), stored manifests under item voice artifacts, and one-click reuse of cleaned references. Proof: `product/desktop/build_target/tool_artifacts/wp_runs/WP-0088/20260306_204301/summary.md`.
