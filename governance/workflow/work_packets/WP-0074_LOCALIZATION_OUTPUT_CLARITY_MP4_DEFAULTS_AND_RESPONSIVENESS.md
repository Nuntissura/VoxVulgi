...
- 2026-03-06: Manual end-to-end smoke succeeded on `Test material\[4K] Queen is here ðŸ˜ Miyeon so cute ðŸ’• (ENG SUB).mp4` via `cargo run --example wp0029_smoke`; proof artifacts written under `product/desktop/build_target/tool_artifacts/wp_runs/WP-0074/manual_smoke_queen/` including `smoke_run.log`, `smoke_summary.md`, `ffprobe_mux_preview.json`, and deliverables (`queen_dub_preview.mp4`, `queen_dub_preview.wav`, `queen_en.srt`, `queen_en.vtt`).
