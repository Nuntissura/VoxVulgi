...
- 2026-03-08: Verified with `cargo test -q --manifest-path product/engine/Cargo.toml`, `cargo test -q --manifest-path product/desktop/src-tauri/Cargo.toml`, and `npm run build` in `product/desktop`; proof in `product/desktop/build_target/tool_artifacts/wp_runs/WP-0117/20260308_161136/`.
