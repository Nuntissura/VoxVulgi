...
| WP-0097 | Shared storage root options and path hydration | BACKLOG | Codex | Planned global download/export root management in Options, with persistent path hydration and no transient missing-folder flicker. |
...
| WP-0100 | Media Library UX and open-path reliability | BACKLOG | Codex | Planned D-drive open-file fix, tighter under-card actions, grouped browsing, and media-type filters for large libraries. |
| WP-0101 | Artifact and output open-action parity | BACKLOG | Codex | Planned consistent `Open file` and `Open parent folder` actions anywhere VoxVulgi creates an output or artifact. |
...
| WP-0103 | Window-switch state retention and freeze reduction | BACKLOG | Codex | Planned pane-state caching and hydration reuse so normal window switching does not keep reloading content. |
| WP-0104 | Desktop shell drag and resize ergonomics | BACKLOG | Codex | Planned drag-region restriction and larger corner-resize hitbox so text selection, scrollbars, and resizing all work normally. |
