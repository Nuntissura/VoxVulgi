...
| WP-0077 | Reusable cast packs | BACKLOG | Codex | Add a series-level cast-pack layer above reusable voice templates so recurring roles can be applied across many episodes. |
| WP-0078 | Multi-reference cloning | BACKLOG | Codex | Allow each template speaker to keep several clean reference clips instead of one, with backward-compatible single-reference support. |
| WP-0079 | Auto-match speaker suggestions | BACKLOG | Codex | Suggest likely diarized-speaker to template/cast-pack mappings with operator review. |
| WP-0080 | Per-speaker style presets | BACKLOG | Codex | Persist reusable delivery styles such as neutral, documentary, game-show, soft, and authoritative. |
| WP-0081 | Pronunciation locks | BACKLOG | Codex | Reuse spoken overrides for names, places, and glossary terms across items, templates, and series. |
| WP-0082 | Emotion and prosody controls | BACKLOG | Codex | Add reusable delivery controls such as slower, warmer, more excited, less robotic, and tighter timing fit. |
...
| WP-0089 | Hybrid clone and standard TTS mode | BACKLOG | Codex | Let major speakers use voice-preserving dubbing while minor speakers use standard TTS in the same item. |
| WP-0090 | Subtitle-aware prosody | BACKLOG | Codex | Use subtitle punctuation, line breaks, and timing structure to shape delivery. |
