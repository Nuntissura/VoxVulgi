...
| WP-0076 | Reusable voice template library | IN_PROGRESS | Codex | Add app-managed reusable voice templates for Localization Studio so saved speaker voice ids/reference clips can be mapped onto new items without rebuilding the setup from scratch. |
