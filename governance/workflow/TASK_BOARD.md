...
| WP-0096 | Localization Studio and archiver IA refresh | BACKLOG | Codex | Planned workspace naming/split hardening so Localization Studio owns first ingest for dubbing while `Video Archiver` and `Instagram Archiver` reflect archive responsibilities clearly. |
...
| WP-0098 | Legacy downloader library reconciliation | BACKLOG | Codex | Planned non-destructive indexing/mapping of large existing downloader/NAS folder trees, playlists, and subscriptions into VoxVulgi. |
| WP-0099 | Video and Instagram Archiver workflows | BACKLOG | Codex | Planned archive UX hardening: subscription folder reveal, Instagram recurring archive refresh, and uncropped recent thumbnail viewing. |
...
| WP-0102 | Startup and performance observability | BACKLOG | Codex | Planned startup progress, deterministic trace capture, and clearer bundled-versus-loaded tool-state visibility. |
...
| WP-0105 | Default media format policy (MP4/JPEG) | BACKLOG | Codex | Planned MP4-first video and JPEG-first image defaults wherever the local toolchain can comply cleanly. |
| WP-0106 | Pinterest archive crawler | BACKLOG | Codex | Planned Pinterest board/folder crawl support inside Image Archive with batch target submission. |
