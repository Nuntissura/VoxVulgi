...
| WP-0098 | Legacy downloader library reconciliation | DONE | Codex | Legacy archive reconciliation is now explicitly read-only and NAS-safe: bounded analysis captures the old 4KVDP install path, writes a local report, and allows operator-tunable index-only import limits without touching legacy files; proof in `product/desktop/Build Target/tool_artifacts/wp_runs/WP-0098/20260307_042415/`. |
