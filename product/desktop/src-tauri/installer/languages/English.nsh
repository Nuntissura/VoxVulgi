LangString addOrReinstall ${LANG_ENGLISH} "Update/Repair installation"
LangString alreadyInstalled ${LANG_ENGLISH} "Already Installed"
LangString alreadyInstalledLong ${LANG_ENGLISH} "${PRODUCTNAME} ${VERSION} is already installed. Choose what to do next and click Next: Update/Repair keeps the current install, Full reinstall uninstalls first, and Uninstall removes the app."
...
LangString chooseMaintenanceOption ${LANG_ENGLISH} "Choose an action: Update/Repair, Full reinstall, or Uninstall."
...
LangString dontUninstall ${LANG_ENGLISH} "Update/Repair in place (no uninstall)"
LangString dontUninstallDowngrade ${LANG_ENGLISH} "Update/Repair in place (Downgrading without uninstall is disabled for this installer)"
...
LangString newerVersionInstalled ${LANG_ENGLISH} "A newer version of ${PRODUCTNAME} is already installed. If you continue with this older version, choose Full reinstall (recommended) or Update/Repair in place, then click Next."
LangString older ${LANG_ENGLISH} "older"
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed on your system. Choose Full reinstall (recommended) or Update/Repair in place, then click Next."
...
LangString uninstallApp ${LANG_ENGLISH} "Uninstall ${PRODUCTNAME} (remove installed files)"
LangString uninstallBeforeInstalling ${LANG_ENGLISH} "Full reinstall (uninstall then install)"
